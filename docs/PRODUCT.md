...
Claude Code is a focused, shareable agent workflow.

## What it does

Delegate bounded coding tasks to Claude Code CLI with explicit scope and review gates. Use when the user explicitly requests this capability or a closely related task.
