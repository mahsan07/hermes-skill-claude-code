...
- **Bounded coding request**
- **Repository instructions**
- **Claude Code session**
- **Local diff and tests**
- **Human review gate**
...
This repository now includes a typed, task-adaptive harness contract for **Claude Code**. The contract maps the skill to memory, planning, capability-orchestration, and action modules; defines bounded repair and stop behavior; and records skill-specific verification evidence.
